				...
				<div class="col-md-12">
					...
					<div class="custom-search-position">
						...
						<div class="pull-right">
							...
							<button type="submit" class="btn btn-primary btn-sm  float-right">검색</button>
						</div>
					</div>
					<!--search-end-->
					<div class="tab-content text-center" id="nav-tabContent">
						<table class="table custom-th-size4">
							...
							<tr>
								<td>1</td>
								<td class="custom-td-elipsis"><a href="/mtms/noticeGet.html">2020 문화주간 관련 안내</a></td>
								<td>ywc412</td>
							</tr>
							<tr>
								<td>1</td>
								<td><a href="/mtms/noticeGet.html" style="text-overflow: ellipsis">2020 문화주간 관련 안내</a></td>
								<td>ywc412</td>
							</tr>
							<tr>
								<td>1</td>
								<td><a href="/mtms/noticeGet.html">2020ffffffffffffffffffffff문화주간 관련 안내</a></td>
								<td>ywc412</td>
							</tr>
							<tr>
								<td>1</td>
						...
						<div class="custom-pagination ">
							<nav aria-label="Page navigation example">
								<ul class="blog-pagination text-center custom-th-size3 custom-th-position">
									<li class="page-item">
