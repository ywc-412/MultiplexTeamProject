									...
									<tr>
										...
										<c:choose>
											<c:when test="${list.suggestPrivateChk eq true}">
												<td id="td"><p class="fa fa-lock" style="margin-right: 8px;"></p><a class="trMove" id="necessaryPw" value="${list.suggestPw}" href="<c:out value="${list.suggestNo}"/>"><c:out value="${list.suggestTitle}"/></a></td>
											</c:when>
											<c:when test="${list.suggestPrivateChk eq false}">
												<td id="td"><a class="trMove" id="nonNecessaryPw" href="<c:out value="${list.suggestNo}"/>"><c:out value="${list.suggestTitle}"/></a></td>
											</c:when>
										</c:choose>
