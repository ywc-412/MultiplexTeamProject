...
<!-- 	계시판명 END -->
	...
	<div class="reply_title_style">
		...
		<div class="reply_report_get_title">${rpvo.replyContent }</div>
	</div>
	<div class="reply_title_style2">
		<div class="reply_report_get_title">${rpvo.memberId }</div>
	</div>
	<div class="high_margin"></div>
	<input type="text" id="content_register" readonly="readonly" value="${rpvo.replyReportContent }" name="reviewReportContent">
...
<div class="modal" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="/report/reply/remove" method="post">
      	<input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }">
      	<input type="hidden" name="replyNo" value="${rpvo.replyNo }">
...
<script>
$(function(){
	var modal = $("#exampleModal1"); //모달창 찾아옴
