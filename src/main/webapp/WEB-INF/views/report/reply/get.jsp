...
<!-- 	계시판명 END -->
	...
	<div class="reply_title_style">
		<div class="reply_report_get_title">한줄평 내용/리뷰댓글 내용</div>
	</div>
	<div class="reply_title_style2">
		<div class="reply_report_get_title">신고자ID</div>
	</div>
	<div class="high_margin"></div>
	<input type="text" id="content_register" readonly="readonly" value="신고사유">
